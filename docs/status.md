...
| [#85](https://github.com/nobhri/azure-dbx-mock-platform/issues/85) | MEDIUM | UC catalog/schema not visible to human user — missing USE CATALOG/USE SCHEMA grants | Per ADR-005: Entra ID group via Native Sync. Runbook updated. Pending: create Entra ID group + run grants. |
