...
| [#105](https://github.com/nobhri/azure-dbx-mock-platform/issues/105) | HIGH | README Current Status and Known Issues stale vs status.md | "In Progress" items are done; Known Issues section diverges from this file. In PR (session 2026-03-13-001). |
| [#106](https://github.com/nobhri/azure-dbx-mock-platform/issues/106) | HIGH | GETTING_STARTED.md prerequisites table has wrong secrets | Appears resolved: `ADLS_STORAGE_NAME` present, `METASTORE_ID` absent in current file. Verify and close manually. |
